"""
Stage 11：即時控制面板的 web server。

不直接 import stage9/graph.py 來跑會議——每個「跑一段」的動作都透過
...
- 跑完的會議轉交給既有的 build_replay.py 產生完整回放頁
"""
...
PRACTICE_DIR = STAGE11_DIR.parent
STAGE9_DIR = PRACTICE_DIR / "stage9"
STAGE10_DIR = PRACTICE_DIR / "stage10"
RUNS_DIR = PRACTICE_DIR / "outputs" / "runs"
WORKER_SCRIPT = STAGE11_DIR / "run_worker.py"
STATIC_DIR = STAGE11_DIR / "static"
...
def get_replay(run_id: str):
    ...
    # run_json_path／report_path 是 run_worker._inspect_final_state() 存的，
